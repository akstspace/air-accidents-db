...
type ModelChoice = 'minilm' | 'gemma' | 'qwen-4b';
        ...
        <Dialog open={open} onOpenChange={(nextOpen) => {
            ...
            <DialogContent className="max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Select the pre-computed embeddings you want to download. This will replace any existing embeddings.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="py-2">
                    ...
                    >
                        ...
                        <div className="flex items-center space-x-3 rounded-lg border p-3 hover:bg-muted/50">
                            <RadioGroupItem value="qwen-4b" id="qwen-4b" />
                            <div className="flex-1 space-y-1">
                                <Label htmlFor="qwen-4b" className="font-medium cursor-pointer">
                                    Ollama - Qwen 4B
                                </Label>
                                <p className="text-xs text-muted-foreground">
                                    Highest quality. Requires Ollama running locally with the qwen3-embedding:4b model.
                                </p>
                            </div>
                        </div>
                    </RadioGroup>
